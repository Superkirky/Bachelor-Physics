%clear all
close all
numfiles = taelfiler('punktum data/');
...
for i = 1:n
    if i < 10
        navn = sprintf('punktum data/stationary000%dpunktum.txt',i);
    elseif i < 100
        navn = sprintf('punktum data/stationary00%dpunktum.txt',i);
    else 
        navn = sprintf('punktum data/stationary0%dpunktum.txt',i);
    end
